...
// Send email to admin if leave application remains pending for 24 hours
...
// Cron: Check attendance at 11:30 AM IST
const attendanceReminderCron = inngest.createFunction({
    ...
    async({ step }) => {
        ...
        // Step 3: Employees on approved leave
        ...
        // Step 4: Employees already checked in
